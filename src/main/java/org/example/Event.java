...
public class Event {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ExchangeInfoMessage exchangeInfoMessage = ExchangeInfoMessage.newBuilder()
                .setEvent(ru.sovcombank.hackaton.proto.Event.newBuilder()
                        .setStatus(Status.newBuilder()
                                .setType(MessageEnumsProto.StatusType.stNotReady)
                                .setDetails("Детальное описание статуса сервиса Родиона")
                                .setNextTime(3200)
